...
func nodeProto(n Node) *v3corepb.Node {
	return &v3corepb.Node{
		...
		Metadata: func() *structpb.Struct {
			...
			return proto.Clone(n.Metadata).(*structpb.Struct)
		}(),
...
func isLocalityEmpty(l Locality) bool {
	return isLocalityEqual(l, Locality{})
}

// isLocalityEqual returns true if clients.Locality l1 and l2 are considered
// equal.
func isLocalityEqual(l1, l2 Locality) bool {
